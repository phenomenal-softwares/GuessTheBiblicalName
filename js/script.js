...
document.getElementById("greeting").style.fontSize = "16px";
setInterval(jesus, 5000);
function jesus(){
let jesusMsg = "j-e-s-u-s" + "<br>" + "loves you!";
  if (document.getElementById("greeting").innerHTML != jesusMsg) {
    ...
    document.getElementById("greeting").style.backgroundColor = "rgba(9,255,0,0.6)";
    document.getElementById("greeting").style.color = "white";
  } else if (document.getElementById("greeting").innerHTML == jesusMsg) {
    document.getElementById("greeting").innerHTML = greeting;
    document.getElementById("greeting").style.backgroundColor = "rgba(255,255,255,0.8)";
...
document.querySelector('#correctImg').src = "correct.png"; //image of correct ans
...
function fill() {
  ...
  //decrease hint count
  if((!incorrectLetters.includes(` ${hintLetters}`) && !correctLetters.includes(hintLetters)) || (!incorrectLetters.includes(` ${lastHint}`) && !correctLetters.includes(lastHint))){
...
//when guesses are exhausted
 ...
 document.querySelector('#correctImg').src = "wrong.png";
 modal2.style.display = "block";
 document.getElementById('word').innerHTML = word;
 document.getElementById('bibleVerse2').innerHTML = hint;
